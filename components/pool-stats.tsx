      ...
      <div className="overflow-hidden rounded-3xl bg-surface p-5 ring-1 ring-border shadow-sm transition-all">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="flex size-7 items-center justify-center rounded-lg bg-surface-2 text-fg ring-1 ring-border">
              <Lock size={14} />
            </span>
      ...
      <div className="rounded-3xl bg-surface p-5 ring-1 ring-border shadow-sm">
        <div className="flex items-center justify-between pb-3 border-b border-border">
          <span className="flex items-center gap-1.5 text-[13px] font-semibold text-fg">
            <Activity size={14} className="text-fg" /> STRK20 Pool Specs
          </span>
          <a
